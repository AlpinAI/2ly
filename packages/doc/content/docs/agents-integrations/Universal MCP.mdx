...
Build custom adapters to integrate specialized AI frameworks or proprietary models with Skilder.
...
Any agent that implements MCP protocol can connect to Skilder:
...
Set when starting `@skilder-ai/runtime`:

| Variable | Required | Description |
|----------|----------|-------------|
| `RUNTIME_NAME` | ✓ | Unique agent identifier |
...
Check runtime appears in Skilder dashboard at http://localhost:8888
...
- Test runtime manually: `npx @skilder-ai/runtime`

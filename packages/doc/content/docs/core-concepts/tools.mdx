---
title: "Tools"
description: "Understanding tools in Skilder"
draft: false
---

Tools are services that agents invoke to interact with external systems. Configure once in Skilder, use across all agents.

---
title: "Agents"
description: "Understanding agents in Skilder"
draft: false
---

Agents are AI systems composed of an LLM, prompts, and tools. Skilder decouples tools from agent logic through a gateway runtime, enabling centralized governance and scalable tool management across all agents.
...
Skilder separates the tool layer from agent frameworks. Instead of integrating tools directly into each agent, agents connect as MCP clients to a runtime that manages tool access, authentication, and execution centrally. This architecture allows you to configure tools once and use them across any agent framework.

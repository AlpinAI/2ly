---
title: 'Architecture'
description: 'Skilder under the hood'
draft: false
---

Skilder connects AI agents to tools via MCP using NATS messaging, DGraph storage, and distributed runtimes.
...
Distributed execution environment (`@skilder-ai/runtime`):
...
For more details, see the [Why Skilder section in Installation](/getting-started/installation#why-Skilder).

## Deployment

### Run locally

Start all Skilder services on localhost via Docker Compose:
...
You can deploy Skilder using official container images:
...
- [Installation](/getting-started/installation) - Set up Skilder in 2 minutes

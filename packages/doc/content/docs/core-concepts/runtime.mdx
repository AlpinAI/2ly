...
A runtime is a Node.js process that connects to the Skilder backend via NATS messaging. It handles tool discovery, request routing, and execution lifecycle. Each runtime registers services and subscribes to specific message channels for coordinating agent-tool interactions.

...
description: "High-level overview of Skilder's distributed architecture"
draft: true
---

Skilder is a distributed platform that connects AI agents to tools via the MCP (Model Context Protocol). It uses NATS for messaging, DGraph for data storage, and distributed runtimes for tool execution.
...
**Quick Start:**
- [Installation](/getting-started/installation) - Get Skilder running locally

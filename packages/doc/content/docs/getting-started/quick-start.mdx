...
[Install Skilder](/getting-started/installation) and ensure it's running at http://localhost:8888
...
Skilder provides a 3-step guided onboarding that walks you through the core concepts:
...
Skilder comes with a selection of popular MCP servers ready to install:
...
- [Architecture](/core-concepts/architecture) - How Skilder works under the hood
- [Runtime Deployment](/deployment/runtime) - Deploy runtimes anywhere
- [Security](/deployment/security) - Secure your Skilder installation

### Production Deployment

Ready to deploy Skilder for production use?

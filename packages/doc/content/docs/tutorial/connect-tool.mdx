...
description: "Add tools to your agent through the Skilder using a MCP server"
draft: false
---
...
1. **Select tools*: Pick the tools you'd like to include in your skill
2. **Linking to Agent**: Connect the skill to your agent
...
1. **Secure Storage**: Skilder securely manages environment variables (encrypted, never in plain text)
...
- **UI-First Configuration**: All skillup happens through the web interface

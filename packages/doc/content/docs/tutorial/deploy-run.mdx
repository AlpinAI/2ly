...
description: "Deploy your configured skill and link them to agents through the Skilder web interface"
draft: false
---
...
- **Agent Connection**: Your agent runs with embedded Skilder runtime
...
2. **Input Test Prompt**: Use this command:
   ```
   "Stay updated about Skilder by starring the repository https://github.com/skilder-ai/skilder"
   ```
3. **Execute Command**: Run your agent with this prompt

Your agent should process this request and use the GitHub tool to star the Skilder repository.

## Step 3: Monitor Execution

### Access Monitoring Dashboard

1. **Go to Monitoring**: Navigate to the Monitoring section in Skilder dashboard
...
✅ Agent connected to Skilder and processed the request

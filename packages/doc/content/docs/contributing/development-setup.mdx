...
description: 'Set up your development environment for contributing to Skilder'
draft: false
---

# For Developers & Contributors

This guide is for **developing Skilder itself**—modifying the codebase, adding features, or fixing bugs.

<Callout type="warn">
  **Just want to use Skilder?** You're in the wrong place. See [Installation](/getting-started/installation) for production
  setup (Docker-only, much simpler).
</Callout>

Set up a local environment for contributing to Skilder. This allows you to run the backend, frontend, and runtime locally with hot reload for rapid development.
...
```bash
git clone https://github.com/YOUR_USERNAME/Skilder.git
cd Skilder
```
...
npm run build -w @skilder-ai/backend
npm run build -w @skilder-ai/frontend
...
- [dev/README.md](https://github.com/skilder-ai/skilder/blob/main/dev/README.md) - Complete command reference

<Callout type="info">
  **Need Help?** Join our [Discord community](https://discord.gg/Skilder-ai) or [open an
  issue](https://github.com/skilder-ai/skilder/issues) on GitHub.
</Callout>

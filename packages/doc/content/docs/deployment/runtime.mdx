...
Skilder runtime provides distributed execution environments for deploying AI agents and tools across Local Docker, Remote, and Edge infrastructure. Runtime manages service orchestration, resource allocation, and scaling for production-grade agent workflows.

## Runtime Architecture

Skilder runtime orchestrates distributed agent execution:
...
Skilder supports three runtime deployment patterns:
...
# Service endpoints
AGENT_REGISTRY_URL=https://agents.Skilder.io
TOOL_REGISTRY_URL=https://tools.Skilder.io
MCP_DISCOVERY_URL=https://mcp.Skilder.io
...
async def create_agent():
    async with TwolyMCP("my-agent") as mcp:
        ...
        # Agent-runtime binding managed by Skilder

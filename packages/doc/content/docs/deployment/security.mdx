---
title: "Security"
description: "Security architecture for Skilder deployments"
draft: true
---

Skilder implements security across network, application, and data layers.
...
```bash
# Store secret
vault kv put secret/Skilder/github token=ghp_xxx

# Retrieve in runtime
GITHUB_TOKEN=$(vault kv get -field=token secret/Skilder/github) \
npx @skilder-ai/runtime
```
...
#!/bin/bash
vault kv put secret/Skilder/github token=$(generate_new_token)

...
export type GetWorkspacesQuery = { workspaces: Array<{ __typename: 'Workspace', id: string, name: string, createdAt: Date }>, system: { __typename: 'System', id: string, defaultWorkspace: { __typename: 'Workspace', id: string, name: string } | null } | null };

...
export type McpLifecycleError = {
  __typename: 'MCPLifecycleError';
  code: Scalars['String']['output'];
  details: Maybe<Scalars['String']['output']>;
  message: Scalars['String']['output'];
};

export enum McpLifecycleStage {
  Completed = 'COMPLETED',
  Failed = 'FAILED',
...
export type McpServerLifecycleEvent = {
  __typename: 'MCPServerLifecycleEvent';
  error: Maybe<McpLifecycleError>;
  message: Scalars['String']['output'];
...
export type Mutation = {
  ...
  testMCPServer: TestMcpServerResult;
...
export type Subscription = {
  ...
  mcpServerTestProgress: McpServerLifecycleEvent;
  mcpServers: Maybe<Array<McpServer>>;
  mcpTools: Maybe<Array<McpTool>>;
...
export type SubscriptionMcpServerTestProgressArgs = {
...
export type TestMcpServerResult = {
  __typename: 'TestMCPServerResult';
...
export type SubscribeMcpServerTestProgressSubscriptionVariables = Exact<{
  testSessionId: Scalars['ID']['input'];
}>;


export type SubscribeMcpServerTestProgressSubscription = { mcpServerTestProgress: { __typename: 'MCPServerLifecycleEvent', stage: McpLifecycleStage, message: string, timestamp: Date, error: { __typename: 'MCPLifecycleError', code: string, message: string, details: string | null } | null, tools: Array<{ __typename: 'MCPTool', id: string, name: string }> | null } };
...
export type TestMcpServerMutation = { testMCPServer: { __typename: 'TestMCPServerResult', success: boolean, testSessionId: string, error: string | null } };
...
export type GetToolCallsQuery = { toolCalls: { __typename: 'ToolCallsResult', totalCount: number, hasMore: boolean, toolCalls: Array<{ __typename: 'ToolCall', id: string, toolInput: string, toolOutput: string | null, error: string | null, calledAt: Date, completedAt: Date | null, status: ToolCallStatus, isTest: boolean, mcpTool: { __typename: 'MCPTool', id: string, name: string, description: string, mcpServer: { __typename: 'MCPServer', id: string, name: string } }, calledBy: { __typename: 'ToolSet', id: string, name: string } | null, executedBy: { __typename: 'Runtime', id: string, name: string, hostname: string | null } | null }>, stats: { __typename: 'ToolCallStats', total: number, pending: number, completed: number, failed: number, avgDuration: number | null } } };
...
export type GetRuntimesQueryVariables = Exact<{
  workspaceId: Scalars['ID']['input'];
}>;


export type GetRuntimesQuery = { workspace: { __typename: 'Workspace', id: string, name: string, runtimes: Array<{ __typename: 'Runtime', id: string, name: string, description: string | null, status: ActiveStatus, type: RuntimeType, createdAt: Date, lastSeenAt: Date | null, hostIP: string | null, hostname: string | null, mcpClientName: string | null }> | null } | null };
...
export type AddMcpToolToToolSetMutation = { addMCPToolToToolSet: { __typename: 'ToolSet', id: string, name: string, description: string | null, updatedAt: Date | null, mcpTools: Array<{ __typename: 'MCPTool', id: string, name: string, description: string, mcpServer: { __typename: 'MCPServer', id: string, name: string } }> | null } };
...
export type GetToolSetsQuery = { toolSets: Array<{ __typename: 'ToolSet', id: string, name: string, description: string | null, createdAt: Date, updatedAt: Date | null, mcpTools: Array<{ __typename: 'MCPTool', id: string, name: string, description: string, mcpServer: { __typename: 'MCPServer', id: string, name: string } }> | null }> | null };

export type GetToolsetKeyQueryVariables = Exact<{
  toolsetId: Scalars['ID']['input'];
}>;


export type GetToolsetKeyQuery = { toolsetKey: { __typename: 'IdentityKey', id: string, key: string, description: string | null, createdAt: Date, expiresAt: Date | null, revokedAt: Date | null, relatedId: string } | null };
...
export type RemoveMcpToolFromToolSetMutation = { removeMCPToolFromToolSet: { __typename: 'ToolSet', id: string, name: string, description: string | null, updatedAt: Date | null, mcpTools: Array<{ __typename: 'MCPTool', id: string, name: string, description: string, mcpServer: { __typename: 'MCPServer', id: string, name: string } }> | null } };
...
export type SubscribeToolSetsSubscription = { toolSets: Array<{ __typename: 'ToolSet', id: string, name: string, description: string | null, createdAt: Date, updatedAt: Date | null, mcpTools: Array<{ __typename: 'MCPTool', id: string, name: string, description: string, mcpServer: { __typename: 'MCPServer', id: string, name: string } }> | null }> | null };
...
export const SubscribeMcpServerTestProgressDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"SubscribeMCPServerTestProgress"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"testSessionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mcpServerTestProgress"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"testSessionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"testSessionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stage"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"error"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"details"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tools"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<SubscribeMcpServerTestProgressSubscription, SubscribeMcpServerTestProgressSubscriptionVariables>;
...
export const GetToolsetKeyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetToolsetKey"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"toolsetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"toolsetKey"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"toolsetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"toolsetId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"revokedAt"}},{"kind":"Field","name":{"kind":"Name","value":"relatedId"}}]}}]}}]} as unknown as DocumentNode<GetToolsetKeyQuery, GetToolsetKeyQueryVariables>;

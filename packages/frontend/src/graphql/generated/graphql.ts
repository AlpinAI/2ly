...
export type GetKnowledgeGraphDataQueryVariables = Exact<{
  workspaceId: Scalars['ID']['input'];
}>;


export type GetKnowledgeGraphDataQuery = { mcpServers: Array<{ __typename: 'MCPServer', id: string, name: string, description: string, repositoryUrl: string, status: McpServerRunOn | null, tools: Array<{ __typename: 'MCPTool', id: string }> | null, runtime: { __typename: 'Runtime', id: string } | null }> | null, mcpTools: Array<{ __typename: 'MCPTool', id: string, name: string, description: string, status: ActiveStatus, mcpServer: { __typename: 'MCPServer', id: string }, runtimes: Array<{ __typename: 'Runtime', id: string }> | null, toolSets: Array<{ __typename: 'ToolSet', id: string }> | null }> | null, workspace: Array<{ __typename: 'Workspace', id: string, name: string, toolSets: Array<{ __typename: 'ToolSet', id: string, name: string, description: string | null, status: ActiveStatus, mcpToolCapabilities: Array<{ __typename: 'MCPTool', id: string }> | null }> | null, runtimes: Array<{ __typename: 'Runtime', id: string, name: string, description: string | null, status: ActiveStatus, capabilities: Array<string> | null, mcpToolCapabilities: Array<{ __typename: 'MCPTool', id: string }> | null, mcpServers: Array<{ __typename: 'MCPServer', id: string }> | null }> | null }> | null };

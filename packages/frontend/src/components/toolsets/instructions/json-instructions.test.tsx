...
// Skipping since JSON instructions are being revamped in the revamp of connect-toolset
describe.skip('JSONInstructions', () => {
  describe('component rendering', () => {
    it('renders instructions with agent name and NATS server', () => {
      render(<JSONInstructions toolsetKey="TSK123456" agentName="My Agent" natsServer="localhost:4222" />);
    ...
    it('renders code block with configuration', () => {
      const { container } = render(
        <JSONInstructions toolsetKey="TSK123456" agentName="Test Agent" natsServer="nats.example.com:4222" />
      );
    ...
    it('displays RUNTIME_NAME and NATS_SERVERS information', () => {
      render(<JSONInstructions toolsetKey="TSK123456" agentName="Test Agent" natsServer="localhost:4222" />);
  ...
  describe('sanitizeAgentName prop behavior', () => {
    describe('when sanitizeAgentName is true', () => {
      it('uses sanitized agent name as JSON key instead of "filesystem"', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="My Agent" natsServer="localhost:4222" sanitizeAgentName={true} />
        );
      ...
      it('sanitizes agent name: converts to lowercase', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="PRODUCTION" natsServer="localhost:4222" sanitizeAgentName={true} />
        );
      ...
      it('sanitizes agent name: replaces spaces with hyphens', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="Production Runtime" natsServer="localhost:4222" sanitizeAgentName={true} />
        );
      ...
      it('sanitizes agent name: removes special characters', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="Agent #1" natsServer="localhost:4222" sanitizeAgentName={true} />
        );
      ...
      it('sanitizes agent name: prefixes with underscore if starts with number', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="123 Agent" natsServer="localhost:4222" sanitizeAgentName={true} />
        );
      ...
      it('sanitizes agent name: falls back to "agent" for empty/invalid names', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="!!!" natsServer="localhost:4222" sanitizeAgentName={true} />
        );
    ...
    describe('when sanitizeAgentName is false or not provided (default)', () => {
      it('uses original agent name as JSON key without sanitization', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="My Agent" natsServer="localhost:4222" />
        );
      ...
      it('preserves uppercase in JSON key', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="PRODUCTION" natsServer="localhost:4222" sanitizeAgentName={false} />
        );
      ...
      it('preserves spaces in JSON key', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="Production Runtime" natsServer="localhost:4222" />
        );
      ...
      it('preserves special characters in JSON key', () => {
        const { container } = render(
          <JSONInstructions toolsetKey="TSK123456" agentName="Agent #1" natsServer="localhost:4222" sanitizeAgentName={false} />
        );
  ...
  describe('JSON configuration structure', () => {
    ...
    it('includes correct environment variables', () => {
      const { container } = render(
        <JSONInstructions toolsetKey="TSK123456" agentName="My Agent" natsServer="custom.nats:4222" />
      );
    ...
    it('uses default NATS server when not provided', () => {
      const { container } = render(<JSONInstructions toolsetKey="TSK123456" agentName="Test" natsServer="" />);
  ...
  describe('acceptance criteria verification (with sanitization enabled)', () => {
    it('uses dynamic agent name instead of hardcoded "filesystem"', () => {
      const { container } = render(
        <JSONInstructions toolsetKey="TSK123456" agentName="MyAgent" natsServer="localhost:4222" sanitizeAgentName={true} />
      );
    ...
    it('removes special characters from JSON key', () => {
      const { container } = render(
        <JSONInstructions toolsetKey="TSK123456" agentName="Agent@#$" natsServer="localhost:4222" sanitizeAgentName={true} />
      );
    ...
    it('generates valid JSON structure that is ready to copy-paste', () => {
      const { container } = render(
        <JSONInstructions toolsetKey="TSK123456" agentName="Test Agent" natsServer="localhost:4222" sanitizeAgentName={true} />
      );

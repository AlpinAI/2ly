 ...
 *
 * WHY: Dialog for configuring an AI provider with API key and settings
 *
 * WHAT IT DOES:
 * - Accepts API key (for cloud providers) or base URL (for Ollama)
 * - Validates credentials on save
 * - Shows available models on success
 */
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder={existingConfig?.isConfigured ? '••••••••••••••••' : 'Enter your API key'}
                      value={apiKey}
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div className="text-sm flex-1">
                      ...
                      >
                        {result.valid ? 'Configuration Validated' : 'Validation Failed'}
                      </p>

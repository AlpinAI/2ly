import pytest
from langchain_skilder.mcp import MCPSkill, _validate_auth
from langchain_skilder.mcp_only import MCPClient
...
class TestMCPClientAuthentication:
    ...
    def test_init_with_workspace_key_and_name(self):
        """Test initialization with workspace_key and name."""
        mcp = MCPClient(name="test", workspace_key="WSK_123")
    ...
    def test_with_workspace_key_factory(self):
        """Test with_workspace_key factory method."""
        mcp = MCPClient.with_workspace_key(name="test", workspace_key="WSK_123")
    ...
    def test_log_level_option(self):
        ...
        mcp = MCPClient(name="test", workspace_key="WSK_123", log_level="debug")

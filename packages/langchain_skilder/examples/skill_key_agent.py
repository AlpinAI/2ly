...
# Get Skilder authentication - skill-specific key (recommended)
# Get your skill key from: Skills page in the Skilder UI
...
if not skill_key:
    print("Error: Please set the SKILL_KEY environment variable with a skill key from Skilder")
    print("Get your key from the Skilder UI: Skills page > Select skill > Copy key")
    exit(1)
...
async def main():
    try:
        ...
        # Requires pre-creating the skill in the Skilder UI

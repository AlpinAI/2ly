...
export function createCacheServiceConfig(): CacheServiceConfig {
  ...
  return {
    initialBuckets: [
      ...
      { name: CACHE_BUCKETS.OAUTH_INITIATION, ttlMs: parseTTL('OAUTH_INITIATION_CACHE_TTL', CACHE_BUCKET_TTLS.OAUTH_INITIATION) },
      ...
      { name: CACHE_BUCKETS.FASTIFY_RATE_LIMIT, ttlMs: parseTTL('FASTIFY_RATE_LIMIT_CACHE_TTL', CACHE_BUCKET_TTLS.FASTIFY_RATE_LIMIT) },
    ],
  };
}

...
import { EncryptionService, AIClientFactory, AIProviderService } from '../services/ai';
...
const start = () => {
  ...
  container.bind(AIClientFactory).toSelf().inSingletonScope();
  ...
  loggerService.setLogLevel('ai-client-factory', (process.env.AI_PROVIDER_LOG_LEVEL || 'info') as pino.Level);

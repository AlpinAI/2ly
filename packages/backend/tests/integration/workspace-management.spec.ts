 ...
 * - Tests run sequentially within file
 */

describe.skip('Workspace Management - Seeded Data', () => {
  ...
  it('should display all seeded workspaces', async () => {
    const query = `
      query GetWorkspaces {
  ...
  it('should query workspace by name filter', async () => {
    const query = `
  ...
  it('should query workspaces with pagination', async () => {
    const query = `
  ...
  it('should order workspaces by name', async () => {
    const query = `
      query GetWorkspaces {
...
describe.skip('Workspace Queries - Edge Cases', () => {
  // Reset and seed database before this describe block
  beforeAll(async () => {
    await resetDatabase();
    await seedDatabase(seedPresets.multipleWorkspaces);
  ...
  it('should handle non-existent workspace ID gracefully', async () => {
    const query = `

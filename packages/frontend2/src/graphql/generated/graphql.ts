...
export type CompleteOnboardingStepMutation = { completeOnboardingStep: { __typename: 'Workspace', id: string, name: string, onboardingSteps: Array<{ __typename: 'OnboardingStep', id: string, stepId: string, type: OnboardingStepType, status: OnboardingStepStatus, priority: number | null, createdAt: Date, updatedAt: Date | null }> | null } };
...
export type DismissOnboardingStepMutation = { dismissOnboardingStep: { __typename: 'Workspace', id: string, name: string, onboardingSteps: Array<{ __typename: 'OnboardingStep', id: string, stepId: string, type: OnboardingStepType, status: OnboardingStepStatus, priority: number | null, createdAt: Date, updatedAt: Date | null }> | null } };

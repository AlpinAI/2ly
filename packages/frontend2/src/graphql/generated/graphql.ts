...
export type SubscribeMcpServersSubscription = { mcpServers: Array<{ __typename: 'MCPServer', id: string, name: string, tools: Array<{ __typename: 'MCPTool', id: string, name: string }> | null }> | null };
